...
export default function Navbar() {
    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light" id='navbar_container'>
            ...
            <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-expanded="false" aria-lable="Toggle navigator">
            ...
            <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul className="navbar-nav">
                    ...
                    <li className='nav-item'>
                        <a className="nav-link" to="/app">Gifts</a>
                    </li>
                    <li className='nav-item'>
                        <a className='nav-link' to="/app/search">SearchPage</a>
                    </li>
